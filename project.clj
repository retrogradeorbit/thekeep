(defproject thekeep "0.1.0-SNAPSHOT"
  ...
  :cljsbuild {:builds
              [{:id "dev"
                ...
                ;; into your build
                :figwheel {:on-jsload "thekeep.core/on-js-reload"
                ...
                :compiler {:main thekeep.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/thekeep.js"
